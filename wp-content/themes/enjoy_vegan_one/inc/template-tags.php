...
if ( ! function_exists( 'enjoy_vegan_one_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function enjoy_vegan_one_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'enjoy_vegan_one' ),
...
if ( ! function_exists( 'enjoy_vegan_one_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function enjoy_vegan_one_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'enjoy_vegan_one' ),
